...
function isMobile() {
    ...
    if (preg_match(
        ...
        . 'lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm(os)?|phone|'
    ...
    if (preg_match(
        ...
        . 'el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|'
        . 'fetc|fly(-|_)|g1 u|g560|gene|gf-5|g-mo|go(\.w|od)|'
        . 'gr(ad|un)|haie|hcit|hd-(m|p|t)|hei-|hi(pt|ta)|hp( i|ip)|'
        . 'hs-c|ht(c(-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i-(20|go|ma)|'
        ...
        . 'sie(-|m)|sk-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|'
